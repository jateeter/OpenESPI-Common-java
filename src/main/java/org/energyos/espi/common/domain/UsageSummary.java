...
import org.energyos.espi.common.models.atom.adapters.UsageSummaryAdapter;
...
@NamedQueries(value = {
		...
		@NamedQuery(name = UsageSummary.QUERY_FIND_ALL_IDS, query = "SELECT usagesummary.id FROM UsageSummary usagesummary"),
