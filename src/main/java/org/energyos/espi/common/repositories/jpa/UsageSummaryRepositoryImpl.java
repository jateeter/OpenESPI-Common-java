	...
	public void createOrReplaceByUUID(UsageSummary usageSummary) {
		...
		try {
			...
			if (usageSummary.getUsagePoint() == null) {
				usageSummary
						.setUsagePoint(existingUsageSummary.getUsagePoint());
			}

			if (existingUsageSummary.getSelfLink() != null) {
				usageSummary.setSelfLink(existingUsageSummary.getSelfLink());
			}

			if (existingUsageSummary.getUpLink() != null) {
				usageSummary.setUpLink(existingUsageSummary.getUpLink());
			}
