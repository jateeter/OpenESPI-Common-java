...
@XmlSeeAlso({ MeterReading.class, UsagePoint.class,
		ElectricPowerUsageSummary.class, UsageSummary.class,
		TimeConfiguration.class, ApplicationInformation.class,
		Authorization.class, Subscription.class,
...
public class ContentType {
	...
	public String buildSelfHref(Long subscriptionId, String hrefFragment) {
		...
		if (this.getUsageSummary() != null) {
			UsagePoint usagePoint = this.getUsageSummary().getUsagePoint();
			RetailCustomer retailCustomer = usagePoint.getRetailCustomer();
			if (subscriptionId != 0L) {
				result = result + "/Subscription/" + subscriptionId;
				if (usagePoint != null) {
			...
			result = result + "/UsageSummary/" + this.getUsageSummary().getId();
		}
