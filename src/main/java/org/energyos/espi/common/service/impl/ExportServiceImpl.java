...
public class ExportServiceImpl implements ExportService {
	...
	public void setUsageSummaryService(UsageSummaryService usageSummaryService) {
	...
	throws IOException {
		exportRootForm("/UsageSummary", subscriptionId, outputStream,
				exportFilter, UsageSummary.class);
	}
	...
	public void exportUsageSummary_Root(Long subscriptionId,
		...
		UsageSummary usageSummary = resourceService.findById(usageSummaryId,
				UsageSummary.class);
		UsagePoint usagePoint = usageSummary.getUsagePoint();

		String hrefFragment = "/Subscription/" + subscriptionId + "/UsagePoint"
				+ usagePoint.getId() + "/UsageSummary/" + usageSummaryId;

		exportEntry(subscriptionId, resourceService.findEntryType(
				usageSummaryId, UsageSummary.class), stream, exportFilter,
				hrefFragment);
	}

	// - XPath form
	@Override
	public void exportUsageSummary(Long subscriptionId, Long retailCustomerId,
			Long usagePointId, Long usageSummaryId, OutputStream stream,
			ExportFilter exportFilter) throws IOException {
		String hrefFragment = "/Subscription/" + subscriptionId
				+ "/UsagePoint/" + usagePointId + "/UsageSummary/"
				+ usageSummaryId;
		exportEntry(subscriptionId, usageSummaryService.findEntryType(
				retailCustomerId, usagePointId, usageSummaryId), stream,
				exportFilter, hrefFragment);
	}

	@Override
	public void exportUsageSummarys(Long subscriptionId, Long retailCustomerId,
	...
	@Override
	public void exportUsagePointFull(Long subscriptionId, Long usagePointId,
			Long retailCustomerId, ServletOutputStream outputStream,
			ExportFilter exportFilter) throws IOException {
		// TODO right now subscriptionId is 1- ...
		String hrefFragment = "/Batch/RetailCustomer/" + retailCustomerId
