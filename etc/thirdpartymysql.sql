...
CREATE TABLE `line_item` (
  ...
  `measurement_powerOfTenMultiplier` varchar(255) DEFAULT NULL,
  `measurement_timeStamp` bigint(20) DEFAULT NULL,
  `measurement_uom` varchar(255) DEFAULT NULL,
  `measurement_value` bigint(20) DEFAULT NULL,
  `measurement_readingTypeRef` varchar(255) DEFAULT NULL,
...
CREATE TABLE `electric_power_usage_summaries` (
  ...
  `currentBillingPeriodOverAllConsumption_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `currentDayLastYearNetConsumption_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `currentDayNetConsumption_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `currentDayOverallConsumption_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `overallConsumptionLastPeriod_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `previousDayLastYearOverallConsumption_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `previousDayNetConsumption_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `previousDayOverallConsumption_readingTypeRef` varchar(255) DEFAULT NULL,
  ...
  `ratchetDemand_readingTypeRef` varchar(255) DEFAULT NULL,
...
CREATE TABLE `usage_summaries` (
  ...
  `usage_point_id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_7b7325ca02a9414ea62fcabc986` (`uuid`),
  KEY `FK_73bd63f6333f44ff8c7f628f79f` (`usage_point_id`),
  CONSTRAINT `FK_73bd63f6333f44ff8c7f628f79f` FOREIGN KEY (`usage_point_id`) REFERENCES `usage_points` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
